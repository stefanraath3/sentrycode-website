...
const featuresData: Feature[] = [
  ...
  },
  {
    ...
    title: "Rapid Decision Analytics",
    paragraph:
  ...
  },
  {
    ...
    icon: (
      <svg width="40" height="42" viewBox="0 0 40 42" className="fill-current">
        <circle cx="20" cy="6" r="3" fill="black" />
        <circle cx="20" cy="36" r="3" fill="black" />
        <circle cx="10" cy="21" r="3" fill="black" />
        <circle cx="30" cy="21" r="3" fill="black" />
        <circle cx="5" cy="10" r="3" fill="black" />
        <circle cx="35" cy="10" r="3" fill="black" />
        <circle cx="5" cy="32" r="3" fill="black" />
        <circle cx="35" cy="32" r="3" fill="black" />
        <path d="M20 6 L10 21" stroke="black" strokeWidth="1" />
        <path d="M20 6 L30 21" stroke="black" strokeWidth="1" />
        <path d="M10 21 L20 36" stroke="black" strokeWidth="1" />
        <path d="M30 21 L20 36" stroke="black" strokeWidth="1" />
        <path d="M20 6 L5 10" stroke="black" strokeWidth="1" />
        <path d="M20 6 L35 10" stroke="black" strokeWidth="1" />
        <path d="M5 10 L10 21" stroke="black" strokeWidth="1" />
        <path d="M35 10 L30 21" stroke="black" strokeWidth="1" />
        <path d="M10 21 L5 32" stroke="black" strokeWidth="1" />
        <path d="M30 21 L35 32" stroke="black" strokeWidth="1" />
        <path d="M5 32 L20 36" stroke="black" strokeWidth="1" />
        <path d="M35 32 L20 36" stroke="black" strokeWidth="1" />
      </svg>
    ),
  ...
  },
  {
    ...
    icon: (
      <svg width="40" height="40" viewBox="0 0 40 40" className="fill-current">
        ...
        />
        <path
          d="M5,20 a1,1 0 0,0 30,0 a1,1 0 0,0 -30,0"
          fill="rgba(0,0,0,0.5)"
        />
        <path
          d="M20,5 a1,1 0 0,1 0,30 a1,1 0 0,1 0,-30"
          fill="rgba(0,0,0,0.3)"
        />
      </svg>
    ),
  ...
  },
  {
    ...
    icon: (
      <svg width="40" height="45" viewBox="0 0 40 45" className="fill-current">
        <rect width="40" height="45" fill="transparent" />
        <path d="M20 10 V30" stroke="black" strokeWidth="4" />
